...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "gwtmvp" because\n';
  ...
  $wnd.__gwt_activeModules['gwtmvp'] = {
    'moduleName' : 'gwtmvp',
    'bindings' : function() {
      return {};
    }
 ...
 * "/gwtmvp.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['gwtmvp'].superdevmode = true;

  var expectedSuffix = '/gwtmvp.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + gwtmvp + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:gwtmvp';
  var devModeSessionKey = '__gwtDevModeSession:gwtmvp';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/gwtmvp/gwtmvp.nocache.js';
  ...
  $wnd.__gwt_activeModules['gwtmvp'].canRedirect = true;
  $wnd.__gwt_activeModules['gwtmvp'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/gwtmvp?user.agent=' + ua + '&_callback=' + callback;
